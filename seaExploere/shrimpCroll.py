...
while True:
    ...
    # 🐙 ENEMY AI (PRIORITY)
    # =====================================================
    val1, loc1 = match(gray_full, shrimp1)
    val2, loc2 = match(gray_full, shrimp2)
